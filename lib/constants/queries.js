...
const INSERT_SEASON = 'INSERT INTO Season (season, year) VALUES ("{0}", "{1}")';
const INSERT_EVENT_TO_SEASON = 'INSERT INTO EventToSeason(event_id, season_id), VALUES({0}, {1})';
