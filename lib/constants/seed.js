...
const EVENT_1 = new Event(1, 1, new Date(2016, 4, 19), 1);
const EVENT_2 = new Event(2, 1, new Date(2016, 4, 18), 2);
const EVENT_3 = new Event(1, 1, new Date(2016, 4, 19), 3);
const EVENT_4 = new Event(1, 2, new Date(2016, 11, 2), 4);
const EVENT_5 = new Event(3, 1, new Date(2016, 4, 19), 5);
const EVENT_6 = new Event(4, 1, new Date(2016, 4, 19), 6);
...
const REPORT_EVENT_1 = new Event(2, 1, new Date(2016, 4, 19), 7);
