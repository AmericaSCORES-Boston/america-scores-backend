  ...
  return seed().then(() => {
    return Promise.using(getSqlConnection(), (connection) => {
      const querys = [
        ...
        'INSERT INTO Measurement (student_id, event_id, height, weight, pacer) VALUES (2, 1, 55, 56, 57)',
        'INSERT INTO Measurement (student_id, event_id, height, weight, pacer) VALUES (3, 2, 44, 16, 50)',
        'INSERT INTO Measurement (student_id, event_id, height, weight, pacer) VALUES (3, 7, 45, 18, 421)'
      ];
