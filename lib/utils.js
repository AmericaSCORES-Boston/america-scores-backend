...
function reportSeed() {
    return Promise.using(getSqlConnection(), (connection) => {
      ...
      'INSERT INTO Event (program_id, event_date) VALUES (1, DATE("2016-05-18"))',
      'INSERT INTO Event (program_id, event_date) VALUES (1, DATE("2016-08-19"))',
      'INSERT INTO Event (program_id, event_date) VALUES (2, DATE("2016-05-18"))',
      'INSERT INTO Event (program_id, event_date) VALUES (2, DATE("2016-08-19"))',
