...
function getAccountID(authID) {
  return accounts.getAccounts({query: authID}).then(function(data) {
    if (data.length === 1) {
...
module.exports = {
  makeResponse, QueryError, isValidDate, isPositiveInteger, query, defined, seed, demoSeed, getAuth0ID
};
