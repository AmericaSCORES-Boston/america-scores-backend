  ...
  return Promise.using(getSqlConnection(), function(connection) {
    ...
    .catch(function(err) {
      ...
      err.code == 'ER_TRUNCATED_WRONG_VALUE') {
        throw new QueryError('InvalidArgumentError', 400, 'ID type error');
      }
      if (err.code == 'ER_NO_REFERENCED_ROW_2') {
        throw new QueryError('ArgumentNotFound', 404, 'ID not found in DB');
      }
      if (err.code == 'ER_BAD_NULL_ERROR') {
        throw new QueryError('InvalidArgumentError', 400, 'Body error');
      }
      throw err;
    });
  });
...
function reportSeed() {
  return seed().then(() => {
    return Promise.using(getSqlConnection(), (connection) => {
      ...
      'INSERT INTO StudentToProgram (student_id, program_id) VALUES (3, 1)',
      'INSERT INTO StudentToProgram (student_id, program_id) VALUES (1, 2)',
      'INSERT INTO StudentToProgram (student_id, program_id) VALUES (2, 2)',

      'INSERT INTO Event (program_id, acct_id, event_date) VALUES (1, 1, DATE("2016-05-18"))',
      'INSERT INTO Event (program_id, acct_id, event_date) VALUES (1, 1, DATE("2016-08-19"))',
      'INSERT INTO Event (program_id, acct_id, event_date) VALUES (2, 1, DATE("2016-05-18"))',
      'INSERT INTO Event (program_id, acct_id, event_date) VALUES (2, 1, DATE("2016-08-19"))',

      'INSERT INTO Measurement (student_id, event_id, height, weight, pacer) VALUES (1, 3, 5, 5, 5)',
      'INSERT INTO Measurement (student_id, event_id, height, weight, pacer) VALUES (1, 4, 7, 7, 7)',
      'INSERT INTO Measurement (student_id, event_id, height, weight, pacer) VALUES (2, 3, 71, 17, 57)',
      'INSERT INTO Measurement (student_id, event_id, height, weight, pacer) VALUES (2, 4, 40, 12, 500)',
      'INSERT INTO Measurement (student_id, event_id, height, weight, pacer) VALUES (3, 1, 44, 16, 500)',
      'INSERT INTO Measurement (student_id, event_id, height, weight, pacer) VALUES (3, 2, 45, 18, 421)'
      ];
...
module.exports = {
  QueryError, isValidDate, isPositiveInteger, query, defined, seed, demoSeed, reportSeed
};
