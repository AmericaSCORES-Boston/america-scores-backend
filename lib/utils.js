...
function reportSeed() {
  return seed().then(() => {
    return Promise.using(getSqlConnection(), (connection) => {
      const querys = [
        'INSERT INTO Event (program_id, event_date) VALUES (2, DATE("2016-05-19"))',

        'INSERT INTO Measurement (student_id, event_id, height, weight, pacer) VALUES (1, 7, 7, 7, 7)',
        'INSERT INTO Measurement (student_id, event_id, height, weight, pacer) VALUES (3, 1, 44, 16, 50)',
...
module.exports = {
  makeResponse, QueryError, isValidDate, isPositiveInteger, query, defined, seed, demoSeed, reportSeed, getAuth0ID
};
