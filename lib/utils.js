...
function reportSeed() {
  return seed().then(() => {
    return Promise.using(getSqlConnection(), (connection) => {
      ...
      'INSERT INTO Event (program_id, acct_id, event_date) VALUES (1, DATE("2016-05-18"))',
      'INSERT INTO Event (program_id, acct_id, event_date) VALUES (1, DATE("2016-08-19"))',
      'INSERT INTO Event (program_id, acct_id, event_date) VALUES (2, DATE("2016-05-18"))',
      'INSERT INTO Event (program_id, acct_id, event_date) VALUES (2, DATE("2016-08-19"))',

      'INSERT INTO Measurement (student_id, event_id, height, weight, pacer) VALUES (1, 3, 5, 5)',
      'INSERT INTO Measurement (student_id, event_id, height, weight, pacer) VALUES (1, 4, 7, 7, 7)',
      'INSERT INTO Measurement (student_id, event_id, height, weight, pacer) VALUES (2, 3, 71, 17)',
      'INSERT INTO Measurement (student_id, event_id, height, weight, pacer) VALUES (2, 4, 40, 12, 500)',
      'INSERT INTO Measurement (student_id, event_id, height, weight, pacer) VALUES (3, 1, 44, 16)',
...
module.exports = {
  makeResponse, QueryError, isValidDate, isPositiveInteger, query, defined, seed, demoSeed, reportSeed
};
