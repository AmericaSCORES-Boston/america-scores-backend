...
function createMissingDateError() {
  return Promise.reject({
    name: 'Missing Date Error',
    status: 400,
    message: 'Missing event_date',
  });
}
...
module.exports = {
  ...
  InvalidKeyError, AuthError, createMalformedDateError, createMissingDateError
};
